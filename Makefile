...
.PHONY: vaccination-execution-projection-recompute vaccination-projection-worker
...
vaccination-projection-worker:
	cd backend && go run ./cmd/vaccination-projection-worker
