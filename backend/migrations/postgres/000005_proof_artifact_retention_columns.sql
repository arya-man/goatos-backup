...
-- +goose Down
-- +goose NO TRANSACTION
DROP INDEX CONCURRENTLY IF EXISTS public.proof_artifacts_abandoned_upload_idx;
DROP INDEX CONCURRENTLY IF EXISTS public.proof_artifacts_retention_expiry_idx;
