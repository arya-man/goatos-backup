...
INSERT INTO legacy_status_mappings (
  ...
  ('legacy_rfid_db', 'F2', 'f2', 'alive', NULL, 'F2', NULL, NULL, NULL, 'F2', 'high', false, 'Plain F2 maps to growth cohort only; source Gender remains sex truth.', now(), now()),
  ('legacy_rfid_db', 'K2', 'k2', 'alive', NULL, 'K2', NULL, NULL, NULL, 'K2', 'high', false, 'Plain K2 maps to growth cohort only; source Gender remains sex truth.', now(), now())
...
WHERE source_system = 'legacy_rfid_db'
  AND normalized_raw_label IN ('f2', 'k2')
  AND raw_label IN ('F2', 'K2');
