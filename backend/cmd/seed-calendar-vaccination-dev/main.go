...
VALUES ('` + itemID + `', $1::uuid, 'VAC-CAL-ET-TT', 'ET+TT Vaccine Calendar Seed', 'vaccine', 'dose', 'active',
        '{"seed":"calendar-vaccination-dev","reference":"docs/preventive-care-vaccination/source-nuances-rules.md"}'::jsonb)
...
INSERT INTO protocol_versions (
  ...
  ('` + versionID + `', $1::uuid, '` + protocolID + `', 'park', '` + cbeParkID + `', 1,
   ...
   '{"category":"vaccination","vaccine":{"code":"ET+TT","name":"ET+TT","type":"toxoid"},"eligibility":{"stage":"K2"},"schedule":[{"dose_code":"ET_TT_4W","trigger_type":"birth_age","offset_days":28,"due_window_days":7,"dose_amount":2,"dose_unit":"ml","route_site":"subcutaneous","max_delay_days":7,"course_lapse_policy":"phc_review"}]}'::jsonb,
