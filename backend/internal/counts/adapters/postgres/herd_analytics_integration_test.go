...
func TestHerdAnalyticsEveryStatusBucketIsDisjointAndComplete(t *testing.T) {
...
func TestHerdAnalyticsReportsAQuietMonthAsZeroRatherThanDroppingIt(t *testing.T) {
	ctx := context.Background()
