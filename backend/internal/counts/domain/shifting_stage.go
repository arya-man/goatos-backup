...
// stage must be an active animal_stage_lookup row (migration 000169 lists it) or it still resolves
...
//     migration 000167 and Flushing left it in 000169.
//
...
// and migration 000169 lists it as writable. See FlushingStageName.
