...
//
// It fans nothing out. UHT feed stock depletes from the preparation itself, on SUBMIT, through the
// feed_effective_external_consumption view (maintainer decision 2026-08-27, migration 000216); the
// retired 2026-08-22 recorder seam wrote a second, differently-dated row into
// feed_external_consumption here and double-deducted the milk. See eventwiring.RegisterVerificationAppliers.
