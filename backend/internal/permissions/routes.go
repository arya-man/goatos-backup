...
var protectedRoutes = []Route{
	...
	{OperationID: "listOperatorSourceCandidates", Method: "GET", Pattern: "/admin/operator-source-candidates", Permissions: []string{OperatorsMapLegacySource}},
	{OperationID: "mapOperatorSourceCandidate", Method: "POST", Pattern: "/admin/operator-source-candidates/{candidate_id}/map", Permissions: []string{OperatorsMapLegacySource}},
	{OperationID: "rejectOperatorSourceCandidate", Method: "POST", Pattern: "/admin/operator-source-candidates/{candidate_id}/reject", Permissions: []string{OperatorsMapLegacySource}},
	...
	{OperationID: "getCountsDashboardSnapshot", Method: "GET", Pattern: "/analytics/counts/dashboard", Permissions: []string{AnalyticsCountsRead}},
	{OperationID: "createCountsSyncRun", Method: "POST", Pattern: "/admin/counts/sync-runs", Permissions: []string{AnalyticsCountsSync}, AdminOnly: true},
	{OperationID: "getCountsSyncRun", Method: "GET", Pattern: "/admin/counts/sync-runs/{sync_run_id}", Permissions: []string{AnalyticsCountsRead}},
