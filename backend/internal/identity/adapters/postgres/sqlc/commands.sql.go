...
type GetCandidateForReviewParams struct {
	TenantID    pgtype.UUID
	CandidateID pgtype.UUID
}

type GetCandidateForReviewRow struct {
	CandidateID     string
	ProposedGoatID  string
	CandidateGoatID string
	MatchScore      float64
...
func (q *Queries) GetCandidateForReview(ctx context.Context, arg GetCandidateForReviewParams) (GetCandidateForReviewRow, error) {
	row := q.db.QueryRow(ctx, getCandidateForReview, arg.TenantID, arg.CandidateID)
	var i GetCandidateForReviewRow
	err := row.Scan(
		&i.CandidateID,
		&i.ProposedGoatID,
		&i.CandidateGoatID,
...
type RejectIdentityMatchCandidateRow struct {
	CandidateID     string
	ProposedGoatID  string
	CandidateGoatID string
	MatchScore      float64
...
func (q *Queries) RejectIdentityMatchCandidate(ctx context.Context, arg RejectIdentityMatchCandidateParams) (RejectIdentityMatchCandidateRow, error) {
	row := q.db.QueryRow(ctx, rejectIdentityMatchCandidate,
		arg.ReviewedBy,
		arg.ReviewedAt,
		arg.DecisionID,
		arg.TenantID,
	...
	var i RejectIdentityMatchCandidateRow
	err := row.Scan(
		&i.CandidateID,
		&i.ProposedGoatID,
		&i.CandidateGoatID,
