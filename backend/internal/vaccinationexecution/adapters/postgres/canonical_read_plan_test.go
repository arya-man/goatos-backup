...
// (docs/decisions/operational-kernel-5k-50k-scale-envelope.md, step 4). The three reads
// (shed / execution / operations) now serve directly from canonical tables via god-CTEs carrying a
