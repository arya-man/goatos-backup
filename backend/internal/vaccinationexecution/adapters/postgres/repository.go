...
const (
	...
	// defaultDriveOptionsLimit is the page the BOARD carries. The full catalogue is paginated
	// behind CommandBoardDriveOptions; see domain.CommandBoardDriveOptionsPageSize.
	defaultDriveOptionsLimit = domain.CommandBoardDriveOptionsPageSize
)
