...
var clockCopyEN = map[string]string{
	...
	"state.clocked_out":       "Day complete · %s",
	...
	"event.clock_out":         "Clock out",
	"detail.captured_at":      "Device time",
	"detail.recorded_at":      "Server time",
	"detail.address":          "Location",
	"detail.coordinates":      "Coordinates",
	"detail.device":           "Device",
	"detail.network":          "Connection",
	"network.online":          "Online",
	"network.offline_queued":  "Recorded offline",
	"grade.cxo":               "CXO",
...
var clockCopyHI = map[string]string{
	...
	"state.clocked_out":       "आज का दिन पूरा · %s",
	...
	"event.clock_out":         "क्लॉक आउट",
	"detail.captured_at":      "फ़ोन का समय",
	"detail.recorded_at":      "सर्वर का समय",
	"detail.address":          "स्थान",
	"detail.coordinates":      "निर्देशांक",
	"detail.device":           "डिवाइस",
	"detail.network":          "कनेक्शन",
	"network.online":          "ऑनलाइन",
	"network.offline_queued":  "ऑफ़लाइन दर्ज",
	"grade.cxo":               "सीएक्सओ",
...
var clockCopyKN = map[string]string{
	...
	"state.clocked_out":       "ಇಂದಿನ ದಿನ ಮುಗಿದಿದೆ · %s",
	...
	"event.clock_out":         "ಕ್ಲಾಕ್ ಔಟ್",
	"detail.captured_at":      "ಫೋನ್ ಸಮಯ",
	"detail.recorded_at":      "ಸರ್ವರ್ ಸಮಯ",
	"detail.address":          "ಸ್ಥಳ",
	"detail.coordinates":      "ನಿರ್ದೇಶಾಂಕಗಳು",
	"detail.device":           "ಸಾಧನ",
	"detail.network":          "ಸಂಪರ್ಕ",
	"network.online":          "ಆನ್‌ಲೈನ್",
	"network.offline_queued":  "ಆಫ್‌ಲೈನ್ ದಾಖಲೆ",
	"grade.cxo":               "ಸಿಎಕ್ಸ್‌ಒ",
...
var clockCopyTE = map[string]string{
	...
	"state.clocked_out":       "ఈరోజు పూర్తయింది · %s",
	...
	"event.clock_out":         "క్లాక్ అవుట్",
	"detail.captured_at":      "ఫోన్ సమయం",
	"detail.recorded_at":      "సర్వర్ సమయం",
	"detail.address":          "లొకేషన్",
	"detail.coordinates":      "కోఆర్డినేట్లు",
	"detail.device":           "పరికరం",
	"detail.network":          "కనెక్షన్",
	"network.online":          "ఆన్‌లైన్",
	"network.offline_queued":  "ఆఫ్‌లైన్ నమోదు",
	"grade.cxo":               "సీఎక్స్ఓ",
