...
//
// The separator is a NUL byte rather than a printable character: dose codes and vaccine codes are
// operator-authored, and a code containing the separator would otherwise let two different rules
// collide on one key.
