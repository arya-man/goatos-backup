...
--
-- Name: vaccination_schedule_dirty_batch_trg(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: vaccination_schedule_dirty_completion_trg(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: vaccination_schedule_dirty_obligation_trg(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: vaccination_schedule_dirty_protocol_trg(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: vaccination_schedule_dirty_tenant_months(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: vaccination_schedule_dirty_workforce_trg(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: vaccination_schedule_projection_dirty_scopes vaccination_schedule_projection_dirty_scopes_pk; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: vaccination_schedule_projection_rows vaccination_schedule_projection_rows_pk; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: vaccination_schedule_projection_state vaccination_schedule_projection_state_pk; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: vaccination_schedule_projection_dirty_pending_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: vaccination_schedule_projection_dirty_scope_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX vaccination_schedule_projection_dirty_scope_key ON public.vaccination_schedule_projection_dirty_scopes USING btree (tenant_id, scope_type, scope_id, year_month);


--
-- Name: vaccination_schedule_projection_rows_lookup_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: obligation_batches vaccination_schedule_dirty_batch_after_write_trg; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER vaccination_schedule_dirty_batch_after_write_trg AFTER INSERT OR DELETE OR UPDATE OF status, planned_date, window_start, window_end, scope_type, scope_id ON public.obligation_batches FOR EACH ROW EXECUTE FUNCTION public.vaccination_schedule_dirty_batch_trg();


--
-- Name: vaccination_completions vaccination_schedule_dirty_completion_after_write_trg; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER vaccination_schedule_dirty_completion_after_write_trg AFTER INSERT OR DELETE OR UPDATE OF administered_at, status, verified_at, obligation_id, batch_id ON public.vaccination_completions FOR EACH ROW EXECUTE FUNCTION public.vaccination_schedule_dirty_completion_trg();


--
-- Name: obligation_instances vaccination_schedule_dirty_obligation_after_write_trg; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER vaccination_schedule_dirty_obligation_after_write_trg AFTER INSERT OR DELETE OR UPDATE OF due_at, window_start, window_end, status, completed_at, batch_id, sop_task_id, target_id, rule_id, protocol_version_id ON public.obligation_instances FOR EACH ROW EXECUTE FUNCTION public.vaccination_schedule_dirty_obligation_trg();


--
-- Name: protocol_versions vaccination_schedule_dirty_protocol_after_write_trg; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER vaccination_schedule_dirty_protocol_after_write_trg AFTER INSERT OR DELETE OR UPDATE OF status, published_at, rule_dsl ON public.protocol_versions FOR EACH ROW EXECUTE FUNCTION public.vaccination_schedule_dirty_protocol_trg();


--
-- Name: workforce_positions vaccination_schedule_dirty_workforce_after_write_trg; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER vaccination_schedule_dirty_workforce_after_write_trg AFTER INSERT OR DELETE OR UPDATE OF workforce_member_id, scope_type, scope_id, status, valid_from, valid_to, position_code, is_backup_slot ON public.workforce_positions FOR EACH ROW EXECUTE FUNCTION public.vaccination_schedule_dirty_workforce_trg();
