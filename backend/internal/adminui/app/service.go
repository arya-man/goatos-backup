...
func pageSpecificCopy(id string) map[string]string {
	...
	case "feed-analytics":
		return map[string]string{
			...
			"stock.farms.col.check":          "Check",
			"stock.farms.batch":              "Load",
			"stock.farms.expected":           "Expected",
			"stock.farms.ledger":             "Ledger",
			"stock.farms.total":              "Total",
			"stock.farms.all":                "All",
			"stock.farms.ok":                 "OK",
			"stock.farms.mismatch":           "Mismatch",
