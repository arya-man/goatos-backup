...
func pageSpecificCopy(id string) map[string]string {
	...
	case "feed-analytics":
		return map[string]string{
			...
			"consumption.title":              "Feed given vs target",
			"consumption.hint":               "One row per shed for the selected day: what the directed sheet said, against what the verifier measured. Rows that differ are flagged.",
			"consumption.empty":              "No directed sheet found for the selected farm and day.",
			"consumption.not_verified":       "Not verified yet",
			"consumption.date.aria":          "Choose which feed day the table and trend show",
			"consumption.trend.title":        "Target vs actual over time",
			"consumption.trend.hint":         "Daily totals for the same farm, ending on the selected day. A gap means no bag was verified that day.",
			"col.consumption.day":            "Feed day",
			"col.consumption.park":           "Farm",
			"col.consumption.shed":           "Shed",
			"col.consumption.breed":          "Breed",
			"col.consumption.age_group":      "Age group",
			"col.consumption.target":         "Target kg",
			"col.consumption.actual":         "Given kg",
			"col.consumption.variance":       "Variance",
