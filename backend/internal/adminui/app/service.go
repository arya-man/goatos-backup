...
func pageSpecificCopy(id string) map[string]string {
	...
	case "feed-analytics":
		return map[string]string{
			...
			"forecast.col.shortfall_cost":   "Cost to buy",
			...
			"consumption.title":              "Feed consumption by shed",
			"consumption.hint":               "Latest feed day in the selected range: target from the directed sheet vs actual/verified packing quantity.",
			"consumption.empty":              "No verified packing quantities found for the latest feed day in this range.",
			"consumption.trend.title":        "Target vs actual trend",
			"consumption.trend.hint":         "Daily total target kg from the directed sheet compared with actual/verified packing kg.",
			...
			"col.consumption.item":           "Feed item",
			"col.consumption.target":         "Target kg",
			"col.consumption.actual":         "Actual / verified kg",
