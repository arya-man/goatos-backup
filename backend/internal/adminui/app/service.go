...
func pageSpecificCopy(id string) map[string]string {
	...
	case "vaccination":
		return map[string]string{
			...
			"command_board.kpi.targets":                        "Targets",
			"command_board.kpi.targets_dl":                     "Animals in program",
			...
			"command_board.shed_matrix.legend.verified":        "Verified",
			...
			"command_board.weekly.title":                       "Doses Given — Weekly",
			"command_board.weekly.meta":                        "By vaccine · amber = given, verifier pending",
			"command_board.weekly.column.week":                 "Week",
			"command_board.weekly.column.vaccine":              "Vaccine",
			"command_board.weekly.column.status":               "Status",
			"command_board.weekly.column.count":                "Doses",
			"command_board.weekly.status.accepted":             "Verified",
			"command_board.weekly.status.recorded":             "Awaiting verification",
			"command_board.weekly.legend.verified":             "Verified doses",
			"command_board.weekly.legend.pending":              "Awaiting verification",
