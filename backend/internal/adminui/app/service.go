...
func pageSpecificCopy(id string) map[string]string {
	...
	case "config":
		return map[string]string{
			...
			"capacity.info":                                             "This counts vaccination administrations, not animals — one animal getting FMD + HS is 2 vaccinations. Mesha splits a shed's work across days when the daily limit is reached; when the work can't fit within the safe window, the shed is flagged Needs review.",
