...
func pageSpecificCopy(id string) map[string]string {
	...
	case "config":
		return map[string]string{
			...
			"modal.rule_editor.guided_title":                            "Vaccination matrix",
			...
			"modal.rule_editor.guided.publish_hint":                     "Draft only until a published SOP is selected and saved. Publishing activates one complete matrix version.",
			...
			"modal.rule_editor.guided.empty_body":                       "This fills ET+TT, PPR, Goat Pox, FMD, HS, Sheep Pox, and Blue Tongue from the current Vaccination Rules matrix.",
			...
			"modal.rule_editor.guided.qualifies_hint":                   "Tags/stages come from the shed/tag lookup. Species, sex, and breed stay as row-level selectors so one matrix can cover all valid permutations.",
			...
			"modal.rule_editor.guided.proof_hint":                       "These tokens become the version proof policy. Publish stays blocked if proof is empty.",
			"modal.rule_editor.guided.advanced_title":                   "Advanced database preview",
			"modal.rule_editor.guided.advanced_hint":                    "This is the exact JSON saved to the backend for the single vaccination.matrix version.",
			"modal.rule_editor.guided.schedule_editor":                  "Edit exact dose rows",
			"modal.rule_editor.guided.schedule_hint":                    "Use this only when timing or proof needs adjustment. The medical safety rules above still apply automatically.",
			"modal.rule_editor.guided.no_active_vaccine":                "Turn on at least one vaccine before saving the matrix.",
