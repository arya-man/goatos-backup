...
func pageSpecificCopy(id string) map[string]string {
	...
	case "feed-analytics":
		return map[string]string{
			...
			"stock.hint":             "What the store holds now, counted the way the farm's stock cards do — GoatOS deducts directed feed as each sheet locks",
			...
			"unit.rupees":            "₹",
			"table.arms.hint":        "Latest sheet day per pen",
			"col.pen":                "Pen",
			"col.arm":                "Arm",
			"col.kg":                 "kg / day",
			"range.30":               "30 days",
			...
			"chart.experiment.title": "Trial feed by pen",
			"chart.experiment.hint":  "Authored kg per trial pen per day (never multiplied by head count)",
			"chart.expitems.title":   "Trial feed by type",
			"chart.expitems.hint":    "Authored kg per feed type per day across the trial sheds",
			"filter.calendar.aria":   "Choose exact dates",
			"filter.from.label":      "From date",
			"filter.to.label":        "To date",
			"filter.apply.label":     "Apply dates",
