...
func pageSpecificCopy(id string) map[string]string {
	...
	case "feed-analytics":
		return map[string]string{
			...
			"table.arms.title":       "Trial arms",
			"chart.experiment.top":   "The largest arms by latest-day kg are charted; the table below lists every arm.",
			...
			"unit.rupees":            "₹",
			"table.arms.hint":        "Latest sheet day per arm",
			"col.arm":                "Arm",
			"col.pens":               "Pens",
			"col.kg":                 "kg / day",
			"range.30":               "30 days",
