	...
	return []domain.PageContract{
		...
		page("action-center", "/action-center", "/action-center", "Action Center", "Exact vaccination work and gaps to act on now.", "command-lens",
			[]domain.TableContract{
				...
				table("stage-review", "Stage/age review", "/admin/vaccination/stage-review-items", []string{"goat", "observed_stage", "age", "reason", "opened", "action"}, "review_item_id"),
			}),
...
func pageSpecificCopy(id string) map[string]string {
	...
	case "action-center":
		return map[string]string{
			...
			"view.stage_review":                   "Stage review",
			...
			"section.stage_review.title":          "Stage/age review",
			"section.stage_review.aria":           "Stage/age review items",
			"section.stage_review.empty":          "No open stage/age mismatch rows.",
			"section.stage_review.rows":           "Rows",
			"field.stage_review.correction_note":  "Correction note",
			"field.stage_review.exception_note":   "Exception note",
			"action.stage_review_corrected":       "Mark corrected",
			"action.stage_review_exception":       "Mark exception",
			"action.stage_review_resolved":        "Stage review resolved.",
			"action.previous":                     "Previous",
			"action.next":                         "Next",
			"label.page":                          "Page",
