...
// parent shed plus its catalog entry. Membership written as location_type='shed' and status='active'
// counts each pen again as its own building. On the live data that was 126 sheds
