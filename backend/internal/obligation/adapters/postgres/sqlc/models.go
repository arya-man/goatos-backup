...
type VaccinationScheduleProjectionDirtyScope struct {
	DirtyScopeID pgtype.UUID
	TenantID     pgtype.UUID
	ScopeType    string
	ScopeID      pgtype.UUID
	YearMonth    pgtype.Date
	Reason       string
	Status       string
	DirtyCount   int32
	FirstDirtyAt pgtype.Timestamptz
	LastDirtyAt  pgtype.Timestamptz
	RebuiltAt    pgtype.Timestamptz
	UpdatedAt    pgtype.Timestamptz
}

type VaccinationScheduleProjectionRow struct {
	TenantID          pgtype.UUID
	ScopeType         string
	ScopeID           pgtype.UUID
	YearMonth         pgtype.Date
...
type VaccinationScheduleProjectionState struct {
	TenantID          pgtype.UUID
	ScopeType         string
	ScopeID           pgtype.UUID
	YearMonth         pgtype.Date
