...
| PPR/FMD | Label-only closed in the 2026-06-26 roster expansion pass. PPR/FMD remain SOP/vocabulary labels; the source audit found sheep/procurement-history notes but no goat timing/dose/booster policy or approved PHC/vet metadata, so no protocol rows or obligations were added. | `wiki/graphify-out/converted/Procurement DB [Goats]_dda03a25.md:78,:86`; SOP playground labels above; `context/execution/vaccination-roster-expansion-followup.md` |
| HS/BQ | Label-only closed in the 2026-06-26 roster expansion pass. HS/BQ remain SOP/vocabulary labels; the source audit found no timing/dose/booster policy or approved PHC/vet metadata, so no protocol rows or obligations were added. | SOP playground labels above; `context/execution/vaccination-roster-expansion-followup.md` |
