...
| Admin-web IA | Aligned. Vertical/module/command-lens taxonomy keeps Parks as a scope/context dimension and command lenses as top-level surfaces. | Future Parks modules can be added only as real modules, not nested command-room routes. |
