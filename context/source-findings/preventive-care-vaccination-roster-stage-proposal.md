...
| --- | --- | --- |
| Schedule-bearing protocol | Use the Vaccination Rules vaccination matrix as the dev/config preset: ET+TT (`2 ml`, kid `28d` + `49d`, adult dose 2 after `21d`, revaccination 6mo only after dose 2/course completion), PPR (`1 ml`, `112d`, revaccination 3y), FMD (`1 ml`, `84d`, revaccination 9mo), HS (`2 ml`, `84d`, revaccination 1y), and Goat Pox (`1 ml`, source 112d but V1 shifted to 140d for live-live spacing with PPR, revaccination 1y). | `docs/preventive-care-vaccination/vaccination-rules.md`; `Vaccination Rules.docx` (formerly `Vaccination Rules.docx`) graph extraction |
