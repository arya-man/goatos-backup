...
| Customer promise safety learnings: identity/eligibility/pricing/booking/feed-trace/replacement/evidence | `context/source-findings/customer-promise-safety-findings.md`; Product cross-phase promise safety section; Product Phase 8 |
