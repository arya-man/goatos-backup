...
| Customer promise safety acceptance cases: retag/stale-tag identity, duplicate cross-system identity, ambiguous refs, phantom/void promises, booked-dead/booked-ineligible goats, listed-but-bad goats, report-only death/treatment, movement-window feed exposure, stale/bad telemetry, impossible parentage | `context/source-findings/customer-promise-safety-findings.md`; Product cross-phase promise safety section; Phase 3/5/6/8/10 |
