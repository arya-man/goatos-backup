...
- `/procurement/source-entry` and `/procurement/source-entry/loads/:id` for
  holding-farm vaccination evidence before arrival.
...
- status-matrix cell → drawer opens, real data (Unknown · Gandhi 1 / Trigger Gate
  PHC Vaccination / Animals 4 / overdue · 4 / next due 2026-06-25), 7 form fields,
...
- PHC PRD requires scan/administer/record dose/upload shed + vial video/verify
