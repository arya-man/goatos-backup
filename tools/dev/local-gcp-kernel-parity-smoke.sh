...
for worker in vaccination-generator obligation-sweeper calendar-projector process-integrity-projector vaccination-shed-projector notification-dispatcher; do
