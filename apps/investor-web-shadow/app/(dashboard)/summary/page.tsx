...
export default function SummaryPage() {
  ...
  const daily: SummaryPeriod = data?.daily ?? { births: 0, deaths: 0, purchases: 0, sales: 0, abortions: 0 };
  const weekly: SummaryPeriod = data?.weekly ?? { births: 0, deaths: 0, purchases: 0, sales: 0, abortions: 0 };
  const monthly: SummaryPeriod = data?.monthly ?? { births: 0, deaths: 0, purchases: 0, sales: 0, abortions: 0 };
