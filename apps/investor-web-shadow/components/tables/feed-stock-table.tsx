...
export function FeedStockTable({ records }: FeedStockTableProps) {
      ...
      <table className="w-full text-xs">
        <thead>
          <tr className="border-b border-[#334155] bg-[#1A1D24]">
            <th className="px-3 py-2.5 text-left font-medium text-[#B0BEC5]">Load Type</th>
            <th className="px-3 py-2.5 text-left font-medium text-[#B0BEC5]">Load ID</th>
            <th className={cn("px-3 py-2.5 text-left font-medium text-[#B0BEC5]", blueTint)}>
              <SortButton field="purchase_date" label="Purchase Date" />
            </th>
            <th className={cn("px-3 py-2.5 text-right font-medium text-[#B0BEC5]", blueTint)}>Consumption/Day</th>
            <th className={cn("px-3 py-2.5 text-right font-medium text-[#B0BEC5]", blueTint)}>Purchased Qty</th>
            <th className={cn("px-3 py-2.5 text-right font-medium text-[#B0BEC5]", blueTint)}>Current Stock</th>
            <th className={cn("px-3 py-2.5 text-right font-medium text-[#B0BEC5]", blueTint)}>Days Consumed</th>
            <th className={cn("px-3 py-2.5 text-center font-medium text-[#B0BEC5]", blueTint)}>Days Left</th>
            {/* Visual divider */}
            <th className="w-px bg-[#334155]" />
            <th className={cn("px-3 py-2.5 text-right font-medium text-[#B0BEC5]", orangeTint)}>Cost</th>
            <th className={cn("px-3 py-2.5 text-left font-medium text-[#B0BEC5]", orangeTint)}>
              <SortButton field="last_payment_date" label="Last Payment" />
            </th>
            <th className={cn("px-3 py-2.5 text-right font-medium text-[#B0BEC5]", orangeTint)}>Last Amt</th>
            <th className={cn("px-3 py-2.5 text-right font-medium text-[#B0BEC5]", orangeTint)}>Paid</th>
            <th className={cn("px-3 py-2.5 text-right font-medium text-[#B0BEC5]", orangeTint)}>Pending</th>
          </tr>
        </thead>
        <tbody>
