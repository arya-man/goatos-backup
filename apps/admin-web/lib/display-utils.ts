...
export const CHART_DESCRIPTIONS: Record<string, string> = {
  ...
  "Adults by Gender": "Gender distribution of adult animals",
  ...
  "Load-wise Age": "Days each purchase load has been on farm since unloading",
  ...
  "Last 5 Weekly ADG by Load": "Average daily weight gain trend by load (grams/day)",
  ...
  // Sales
  "Month-wise Sale Count": "Monthly number of animals recorded in sales",
  "Month-wise Sales Amount": "Monthly sales value based on recorded sale amount",
  "Sales vs Feed Expenditure": "Monthly sales revenue compared with feed spend",
