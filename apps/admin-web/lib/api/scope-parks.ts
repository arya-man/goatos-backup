...
// read API and passed to the client shell so the top bar can show a HUMAN park label (CBE) while the URL/
// API carry the backend-safe location UUID. On any error it returns [] — the shell then shows the raw scope
// id behind a "Selected park" label rather than crashing.
