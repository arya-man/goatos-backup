...
const COPY_FALLBACKS: Record<string, Record<string, string>> = {
  "weighing-weights": {
    "growth_director.aria": "Growth Director",
    "growth_director.title": "Growth Director",
    "growth_director.unit_g": "g",
    "growth_director.road.aria": "Road to sale weight",
    ...
    "growth_director.road.caption_matched": "kids matched to the herd register of",
    "growth_director.road.caption_identities": "tags seen.",
    "growth_director.road.movement_aria": "Band movement since last weigh",
    "growth_director.road.moved_up": "Moved up a band",
    "growth_director.road.moved_up_dl": "since their last weigh",
    "growth_director.road.held": "Held their band",
    "growth_director.road.held_dl": "no band change since last weigh",
    "growth_director.road.moved_down": "Slipped back",
    "growth_director.road.moved_down_dl": "dropped a band since last weigh",
    "growth_director.road.empty": "No kids weighed one by one in this period yet.",
    "growth_director.road.unit": "kids",
    "growth_director.road.footnote_pairs": "A kid has to be weighed twice before it can move a band —",
    "growth_director.road.footnote_of": "of",
    "growth_director.road.footnote_tail": "have a second weigh. Whole-shed weighings are not counted here; a band needs a kid weighed one by one.",
    "growth_director.fair_fight.aria": "Fair fight — same breed, same sex",
    ...
    "growth_director.fair_fight.empty_title": "No like-for-like comparison yet",
    "growth_director.fair_fight.empty_body": "It needs the same kind of kid, weighed twice, in two different sheds.",
    "growth_director.watchlist.aria": "Slow-growth watchlist",
    "growth_director.watchlist.title": "Slow-growth watchlist",
    "growth_director.watchlist.caption": "Groups of kids that are not gaining — worth a walk to the shed. Same breed and sex grouped together, so it points at a shed problem, not one sick kid.",
    "growth_director.watchlist.empty_title": "No slow groups right now",
    "growth_director.watchlist.empty_body": "Every group with enough second weighs is gaining. Small groups stay hidden until 3 kids have a second weigh.",
    "growth_director.watchlist.th_shed": "Shed",
    "growth_director.watchlist.th_breed": "Breed",
    "growth_director.watchlist.th_sex": "Sex",
    "growth_director.watchlist.th_pairs": "Kids weighed twice",
    "growth_director.watchlist.th_gain": "Median daily gain",
    "growth_director.watchlist.th_status": "Status",
    "growth_director.watchlist.status.on_track": "On track",
    "growth_director.watchlist.status.below_target": "Below target",
    "growth_director.watchlist.status.losing": "Losing / flat",
    "growth_director.watchlist.target_note": "Target of",
    "growth_director.watchlist.target_note_tail": "g a day is the ops rule of thumb, not a contract. Changes within 3% of body weight count as gut fill; losses over 0.3 kg a day are treated as bad scans, not slow growth.",
    "growth_director.feed.aria": "Feed given vs growth",
    "growth_director.feed.title": "Feed given vs growth (estimate)",
    "growth_director.feed.caption": "Feed we told the team to give, not feed the kids finished — leftovers are not weighed yet. Read every number here as an estimate.",
    "growth_director.feed.empty_title": "Nothing to compare yet",
    "growth_director.feed.empty_body": "A kid has to be weighed twice before feed can be measured against gain.",
    "growth_director.feed.th_shed": "Shed",
    "growth_director.feed.th_feed": "Feed directed, per head per day",
    "growth_director.feed.th_gain": "Daily gain",
    "growth_director.feed.th_ratio": "Feed kg per kg gained",
    "growth_director.feed.th_basis": "Basis",
    "growth_director.feed.needs_second_weigh": "needs a second weigh",
    "growth_director.feed.trial": "trial",
    "growth_director.feed.basis.per_animal": "Per animal",
    "growth_director.feed.basis.whole_shed": "Whole shed",
    "growth_director.feed.footnote": "High feed with low gain is a ration, waste or health question for that shed this week. A trial shed runs the experiment sheet (absolute kg, no per-head rate) so its ratio is not comparable.",
    "growth_director.problems.aria": "Feed sheet problems",
    "growth_director.problems.title": "Feed sheet problems",
    "growth_director.problems.caption_history": "blocked lines on record —",
    "growth_director.problems.caption_latest": "on the latest feed day. A blocked line means the sheet had no ration to print, so the shed may have been fed by guesswork.",
    "growth_director.problems.empty_title": "No blocked lines",
    "growth_director.problems.empty_body": "Every feed line on the latest sheet had an authored ration.",
    "growth_director.problems.th_shed": "Shed",
    "growth_director.problems.th_item": "Feed item",
    "growth_director.problems.th_days": "Days blocked",
    "growth_director.problems.th_reason": "Reason",
    "growth_director.problems.zero_note_head": "Blocked is not zero — blocked means nobody authored a ration.",
    "growth_director.problems.zero_note_tail": "zero-kg lines exist on purpose (milk-fed kids) and are not listed here.",
    "growth_director.trust.aria": "Can we trust these numbers",
    "growth_director.trust.title": "Can we trust these numbers?",
    "growth_director.trust.caption": "Every gain number in this block stands on these counts. Fixing them is the cheapest way to make the whole page better.",
    "growth_director.trust.matched": "Scans matched to a kid",
    "growth_director.trust.matched_dl": "of",
    "growth_director.trust.matched_dl_tail": "scans —",
    "growth_director.trust.unmatched_dl_tail": "don't match any tag in the herd register",
    "growth_director.trust.pairs": "Kids weighed twice",
    "growth_director.trust.pairs_dl": "growth can only be computed for these",
    "growth_director.trust.once": "Weighed once only",
    "growth_director.trust.once_dl": "a second weigh unlocks their gain",
    "growth_director.trust.whole_shed": "Whole-shed weighings",
    "growth_director.trust.whole_shed_dl": "average only — no per-kid, breed or sex view",
    "growth_director.trust.pending": "Awaiting verification",
    "growth_director.trust.pending_dl": "counted in growth, not yet confirmed",
    "growth_director.trust.rework": "Sent for rework",
    "growth_director.trust.rework_dl": "bounced proof — excluded from growth math",
  },
  "control-tower": {
    "label.scope": "Scope",
    "label.detail": "Detail",
