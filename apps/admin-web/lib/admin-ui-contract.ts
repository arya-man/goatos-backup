...
const COPY_FALLBACKS: Record<string, Record<string, string>> = {
  ...
  "protocol-adherence": {
    ...
    "adherence.help.current_prefix": "Current value:",
    "adherence.help.expected_label": "expected",
    "adherence.help.formula": "Formula: completed vaccine obligations divided by expected vaccine obligations.",
    "adherence.help.loading": "The exact percent appears after the adherence summary loads.",
    "adherence.help.title": "How adherence is calculated",
    "adherence.help.window_joiner": "to",
    "adherence.help.window_prefix": "The system looks at vaccination obligations expected in this adherence window:",
    "label.due_lower": "due",
    "label.info_icon": "i",
  },
  "goat-passport": {
