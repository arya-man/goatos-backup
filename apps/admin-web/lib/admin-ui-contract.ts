...
const COPY_FALLBACKS: Record<string, Record<string, string>> = {
  "weighing-weights": {
    ...
    "growth_director.feed_growth.note": "High feed with low gain is a ration, waste, or health question for that shed this week.",
    ...
    "growth_director.trust.pairs.sub": "growth can only be worked out for these",
    "growth_director.trust.once_only": "Weighed once only",
