...
const COPY_FALLBACKS: Record<string, Record<string, string>> = {
  ...
  vaccination: {
    ...
    "section.full_schedule.note": "Month schedule by park, shed, animal type, and vaccine.",
    "section.full_schedule.empty_title": "No schedule rows for this month",
    "section.full_schedule.empty_body": "Rows appear once published vaccination protocols generate shed-level due work for the selected month.",
