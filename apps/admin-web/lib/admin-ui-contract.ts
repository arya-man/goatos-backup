...
const COPY_FALLBACKS: Record<string, Record<string, string>> = {
  ...
  "weighing-weights": {
    ...
    "growth_director.fair_fight.caption": "Same breed, same sex, different pens — a fairer comparison that points at pen-level causes. Feed, age, starting weight and health can still differ; it narrows the question, it does not close it.",
  ...
  vaccination: {
    ...
    "command_board.future_drives.column.sheds": "Pens",
    ...
    "command_board.pending_sheds.meta": "Only overdue and verification-pending vaccines, grouped by pen.",
  ...
  vaccination: {
    "full-vaccine-schedule": {
      ...
      columns: [
        ...
        { key: "sheds", label: "Pens", sortable: false, visible: true },
    ...
    "inventory-vaccine-progress": {
      ...
      columns: [
        ...
        { key: "shed", label: "Pen", sortable: false, visible: true },
