...
const TABLE_DATASET: Record<string, string> = {
  ...
  fattening_load_sales_comparison: "procurement_farm",
  // Shiftings
  ...
  // procurement_farm (loadwise summary)
  loadwise_summary: "procurement_farm",
  // feedDB
  ...
  // Feed consumption
  feedDB_clean: "feedDB",
  feedDB_load_summary: "feedDB",
  // salesDB
  salesDB_clean: "salesDB",
  // crop_season
  seasons_clean: "crop_season",
  // ceo_dashboard (default dataset — listed explicitly for clarity)
  total_summary_breeding: "ceo_dashboard",
  monthly_feed_vs_sales: "ceo_dashboard",
  monthly_animals_vs_feed: "ceo_dashboard",
};
