...
export default async function Page({ searchParams }: { searchParams: Promise<RouteSearchParams> }) {
  const [params, pageContract] = await Promise.all([searchParams, requireAdminWebPageContract("audit-log")]);
  return <OperationsAuditPage searchParams={params} pageContract={pageContract} />;
}
