...
export function sortDriveCampaignsNewestFirst(campaigns: ScheduledDriveCampaign[]): ScheduledDriveCampaign[] {
  return [...campaigns].sort((a, b) => {
    const dateOrder = (b.dateKeys[0] ?? "").localeCompare(a.dateKeys[0] ?? "");
