...
export async function VaccinationExecutionSection({ searchParams, pageContract }: { searchParams?: RouteSearchParams; pageContract: AdminUiPageContract }) {
  return (
    <section id="execution" style={{ scrollMarginTop: 80 }}>
      ...
      <VaccinationExecutionBoard searchParams={searchParams} basePath="/vaccination" pageContract={pageContract} />
    </section>
  );
}
