    ...
    <aside className={`drawer${open ? " on" : ""}`} aria-label={copy(pageContract, "drawer.work_item.aria")} aria-hidden={!open} inert={!open}>
      ...
      <div className="dc">
        ...
        <div className="metagrid">
          ...
          <div><div className="k">{copy(pageContract, "drawer.park_shed_label")}</div><div className="v">{row.park_name} · {row.operational_location_display || operationalLocationLabel({ shedName: row.shed_name })}</div></div>
