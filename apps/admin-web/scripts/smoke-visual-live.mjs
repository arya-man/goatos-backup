...
const KNOWN_ROUTE_NAMES = [
  ...
  "sops-builder", "counts-herd", "counts-breakdown", "counts-sheds", "counts-milk-preparation", "operations-audit", "operations-dlq",
...
const routes = [
  ...
  { name: "counts-sheds", path: "/counts/sheds?scope_mode=company" },
