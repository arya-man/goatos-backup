// telemetry:exempt Feature module configuration — analytics wiring lives in the :app ViewModels
// (ClockViewModel / ClockTeamViewModel / ClockStatusViewModel), see the screens' own exempts.
plugins {
...
android {
    namespace = "sg.mesha.goatos.feature.clock"
    compileSdk = 36
    defaultConfig {
        minSdk = 29
    }
