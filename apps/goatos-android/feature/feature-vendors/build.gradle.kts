...
// in :app (the Vendors ViewModels), which wire AnalyticsEventsVendors
// events and CrashReporter for every read refresh, capture, and queued write.
...
android {
    namespace = "sg.mesha.goatos.feature.vendors"
    compileSdk = 36
    defaultConfig {
        minSdk = 29
    }
