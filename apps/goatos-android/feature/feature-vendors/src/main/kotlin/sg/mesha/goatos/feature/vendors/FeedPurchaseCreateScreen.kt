...
private const val HINT_DELIVERY = "Leave the reached date blank if the load is still on the road. It is counted as stock only once it reaches."
...
private const val CLEAR_DATE = "Still on the road"
