...
object AnalyticsEvents {
    ...
    const val VACCINATION_SCAN_ROSTER_REFRESH_ATTEMPTED = "vaccination_scan_roster_refresh_attempted"
    const val VACCINATION_SCAN_ROSTER_REFRESH_COMPLETED = "vaccination_scan_roster_refresh_completed"
    const val VACCINATION_SCAN_ROSTER_PAGE_REVEALED = "vaccination_scan_roster_page_revealed"
    const val VACCINATION_SCAN_ACTION = "vaccination_scan_action"
    const val VACCINATION_PROOF_ACTION = "vaccination_proof_action"
    const val VACCINATION_SUBMIT_DIALOG_OPENED = "vaccination_submit_dialog_opened"
    const val VACCINATION_SUBMIT_DIALOG_CANCELLED = "vaccination_submit_dialog_cancelled"
    const val VACCINATION_SUBMIT_DIALOG_CONFIRMED = "vaccination_submit_dialog_confirmed"
