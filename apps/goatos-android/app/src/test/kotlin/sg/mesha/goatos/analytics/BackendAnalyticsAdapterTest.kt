...
class BackendAnalyticsAdapterTest {
    ...
    fun `the critical event allowlist covers the documented forensic events`() {
        ...
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAPTURE_COMPLETED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_PROCESSING_STARTED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_PROCESSING_COMPLETED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_PROCESSING_FAILED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_GALLERY_SAVE_STARTED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_GALLERY_SAVE_COMPLETED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_GALLERY_SAVE_FAILED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_UPLOAD_REGISTERED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_UPLOAD_STARTED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_UPLOAD_COMPLETED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_UPLOAD_FAILED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_UPLOAD_ENQUEUE_FAILED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_UPLOAD_DRIVER_MISSING))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_REQUESTED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_VISIBLE))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_BOUND))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_STREAMING))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_RECORDING_STARTED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_STOP_TAPPED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_CANCELLED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_RETRY_TAPPED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_FINALIZED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_FAILED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_TORCH_ON))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_TORCH_OFF))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_CAMERA_TORCH_FAILED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_GALLERY_PICKER_OPENED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_GALLERY_PICKER_CANCELLED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_GALLERY_PICKER_IMPORTED))
        assertTrue(allowlist.contains(AnalyticsEvents.PROOF_GALLERY_PICKER_FAILED))
        assertTrue(allowlist.contains(AnalyticsEvents.SYNC_WRITE_DEPENDENCY_WAIT))
        ...
        assertTrue(allowlist.contains(AnalyticsEvents.PC_CARE_SUBMIT_BLOCKED))
        ...
        assertTrue(allowlist.contains(AnalyticsEvents.WEIGHING_SUBMIT_ATTEMPT))
        assertTrue(allowlist.contains(AnalyticsEvents.WEIGHING_SUBMIT_SUCCESS))
        assertTrue(allowlist.contains(AnalyticsEvents.WEIGHING_SUBMIT_FAILURE))
        assertTrue(allowlist.contains(AnalyticsEventsWeighing.WEIGHING_SUBMIT_ATTEMPTED))
        assertTrue(allowlist.contains(AnalyticsEventsWeighing.WEIGHING_SUBMIT_SUCCEEDED))
        assertTrue(allowlist.contains(AnalyticsEventsWeighing.WEIGHING_SUBMIT_FAILED))
        assertTrue(allowlist.contains(AnalyticsEventsWeighing.WEIGHING_SUBMIT_CONFIRMATION_OPENED))
        assertTrue(allowlist.contains(AnalyticsEventsWeighing.WEIGHING_SUBMIT_CONFIRMATION_CONFIRMED))
        assertTrue(allowlist.contains(AnalyticsEventsWeighing.WEIGHING_SUBMIT_CONFIRMATION_CANCELLED))
