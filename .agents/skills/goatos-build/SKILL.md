...
| `references/backend-impl.md` | Extending/reviewing built Go backend code, Phase 1 identity read APIs, backend package patterns, request middleware, tenant-scoped queries, or sqlc follow-up |
