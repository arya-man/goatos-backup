...
<!-- Coupling review 2026-08-30: a manual vaccination anchor may be dose 1, a booster, or a revac campaign, and may be in the future. The anchor date is the course base for the selected animals and vaccine family; follow-on doses derive from the anchor or its accepted completion, not DOB/arrival/calendar backfill. For this class of change, replay generator/sweeper on the maintainer OCI Postgres staging-data clone before deploy; do not require laptop Docker/Colima. -->
