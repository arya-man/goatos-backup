...
| Config/matrix setup | Closed for V1 demo | `NUANCE-RULES-20260701-V1-MATRIX-R2` loads the Nuance Rules matrix, previews impact, saves drafts, publishes ET+TT, PPR, Goat Pox, FMD, and HS as separate protocol versions, and reopens the drawer with source metadata. | Additional source rows are data entry, not a V1 code blocker. |
