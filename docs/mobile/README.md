...
| [production-facing-release.md](production-facing-release.md) | Current public/operator-facing Android package, URLs, version naming, and existing-Firebase-project reuse contract |
