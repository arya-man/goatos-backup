...
Migration `000248_notification_type_daily_alerts.sql` widens the enum for all four together.
...
| the enum widening | `backend/migrations/postgres/000248_notification_type_daily_alerts.sql` |
