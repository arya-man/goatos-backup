...
baseline line for new work. Fix the query, batch the writes, add a real
projection/read model, use keyset cursors, or add a narrow inline
`scale-guard:ignore` with a concrete boundedness reason.
