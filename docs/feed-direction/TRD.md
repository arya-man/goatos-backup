...
**Mobile/SOP cutover:**
[SOP Mobile Cutover PRD](./SOP-MOBILE-CUTOVER-PRD.md) and
[SOP Mobile Cutover TRD](./SOP-MOBILE-CUTOVER-TRD.md)
**Legacy reference:**
...
| Sheds DB | Manual ground-reality shed tag, capacity-like, area, and potential-tag matrix by park (`context/source-findings/sheds-db-source-findings.md`) | Source evidence for governed Location/Park profile CRUD and effective-dated capacity/tag review. Do not copy as Feed runtime truth; birth, breeding, procurement, health/ICU/quarantine, and ShiftingEvent workflows should update/schedule profile or placement work. Missing or conflicting destination profile blocks Feed generation. |
